...
sprites.height = 16
-- Projectile
sprites.move = loadgfx("Doom2D/effects/BIMPFIRE.png")
...
-- Creating
d2d.projectiles.impball.id = addprojectile("d2d.projectiles.impball")

function d2d.projectiles.impball.create(x, y, rotation_angle, speed, damage, accuracy, ignored_object)
	pid = createprojectile(d2d.projectiles.impball.id)
	projectiles[pid] = {}
...
function d2d.projectiles.impball.draw(id)
...
function d2d.projectiles.impball.animation(id)
...
function d2d.projectiles.impball.update(id)
	-- Lifetime
	...
	d2d.projectiles.impball.animation(id)
	d2d.projectiles.impball.move(id)
end

function d2d.projectiles.impball.move(id)
	if projectiles[id].is_explosed then
